...
class Game {
  ...
  getUnKilledCreatures = async (teamID, eventID) => {
  ...
  pickRandomCreature = (liveCreaturesIDs) => {
  ...
  killCreatures = async (eventID, teamID) => {
